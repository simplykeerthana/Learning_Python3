# scripting in python
#writing scripts using scripting, the power of python

#process images, convert pdf's and etc.

#what is image processing
# for ex, instagram process images by cropping pictures, reducing the size and etc
